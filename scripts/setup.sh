...
echo; echo " SCRIPT > Questo script necessita di una connessione ad internet, PRIMA DI CONTINUARE ASSICURARSI DI AVERE CONNESSO IL CAVO DI RETE O IL WIFI E DI ESSERE ONLINE"
echo
